        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              ...
              <?php else :?>
                <a href="register"  class="<?= urlIs('/laracast/register') ? 'bg-gray-900 text-white' :  'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium  hover:bg-white/5 text-white">Register</a>
                <a href="login"  class="<?= urlIs('/laracast/login') ? 'bg-gray-900 text-white' :  'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium  hover:bg-white/5 text-white">Login</a>
              <?php endif; ?>
